...
const contentOverview: TContentCourses[] = [
    {
        ...
        mainText: `Są to kursy skierowane do dzieci i młodzieży w wieku szkolnym oraz dla przedszkolaków. Na
        kursach standardowych, Kursanci nabywają nowe umiejętności językowe w sposób
        systematyczny, a zagadnienia i tematyka zajęć dostosowane są do rozwoju intelektualnego i
        emocjonalnego uczniów.`,
        // list: [
        //     "3,4,5 latki - zajęcia odbywają się 1 raz w tygodniu i trwają 45 minut (rocznie 33 lekcje).",
        //     "6 latki i szkoła podstawowa - zajęcia odbywają się 2 razy w tygodniu i trwają 60 minut (rocznie 66 lekcji).",
        //     "liceum - zajęcia odbywają się 1 razy w tygodniu i trwają 90 minut (rocznie 33 lekcje).",
        // ],
    },
