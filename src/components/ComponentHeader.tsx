...
const ComponentHeader: React.FC = () => {
	return (
		<header className="relative h-[700px] w-screen p-16 sm:p-8 sm:h-[90vh]">
			...
			<div className="container relative z-10 flex h-full flex-col gap-6 sm:justify-start">
				<div className="flex h-fit w-full flex-col items-start justify-start">
					<p className="leading-[1em] font-libre-baskerville w-4/5 text-left text-[5em] font-bold text-platinum sm:text-[4em]">YOUR</p>
					<p className="leading-[1em] font-libre-baskerville w-4/5 text-left text-[5em] font-bold text-platinum sm:text-[4em]">
						ENGLISH
					</p>
					<p className="leading-[1em] font-libre-baskerville w-4/5 text-left text-[5em] font-bold text-platinum sm:text-[4em]">
						SCHOOL
