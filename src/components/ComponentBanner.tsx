...
const ComponentBanner: React.FC = () => {
	return (
		<section className="h-[500px] w-full bg-platinum p-16 sm:h-auto sm:p-8">
			<Element name="banner" className="container relative flex size-full flex-row-reverse gap-4 sm:flex-col-reverse">
				...
				<div className="w-1/2 md:w-full shadow-base">
					<img className="size-full object-cover brightness-75 md:aspect-golden-horizontal" src={contentBanner.image} alt="Banner" />
